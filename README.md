...
Captures prises dans l'application, sur le projet du guide NosFire 3 (250 répliques,
125 paires FR/EN liées, environ 47 minutes de vidéo).

### L'éditeur, la fenêtre principale

![L'éditeur](screenshots/editeur-studio.jpg)

Chaque ligne est une réplique : locuteur, langue, mode de voix, média, audio. Les paires FR/EN
restent liées et alignées. À gauche les scènes et les voix TTS, à droite le panneau média avec
l'aperçu, le recadrage et la configuration des bulles.

### Écrire et découper le dialogue

| | |
|---|---|
| ![Édition d'une réplique](screenshots/edition-replique.jpg) **Édition d'une réplique** : le texte lu par la voix de synthèse, en plein écran. | ![Découpe d'une séquence](screenshots/decoupe-sequence.jpg) **Découpe d'une séquence** : une paire FR/EN se coupe en plusieurs, les deux langues restent alignées. |

### Les médias

| | |
|---|---|
| ![Montage média](screenshots/timeline-montage.jpg) **Montage (timeline)** : clips, images et textes d'une séquence, avec la facecam incrustée par-dessus. | ![Recadrage interactif](screenshots/recadrage-interactif.jpg) **Recadrage interactif** : les poignées cadrent la capture directement sur l'image. |

### Voix et caméra

| | |
|---|---|
| ![Enregistrement audio](screenshots/enregistrement-audio.jpg) **Enregistrement audio** : le texte sert de téléprompteur, la voix réelle remplace le TTS sur la réplique. | ![Studio caméra](screenshots/studio-camera.jpg) **Studio caméra** : facecam en médaillon, filtre, fond de diapo et téléprompteur pour tourner en une prise. |

### L'export

![Onglet Export](screenshots/onglet-export.jpg)

Format paysage (YouTube) ou vertical (Reels, TikTok, Shorts), qualité, encodage GPU NVENC,
segments en parallèle. Le rendu produit le MP4 et les chapitres YouTube.
